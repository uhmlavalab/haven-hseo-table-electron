...
import { WindowService, InputService, AppRoutes, AppInput, PlanStateService, StateUpdateType } from '@app/core';
...
export class PuckWindowLayoutComponent implements OnInit, OnDestroy {
  ...
  constructor(private router: Router, private electronService: WindowService, private activeRoute: ActivatedRoute, private ngZone: NgZone, private inputService: InputService, private planService: PlanStateService) {
